...
function convertPublicKeyToXY(publicKey) {
...
async function createDID(ethereumAddress, privateKey, isInBrowser, publicKey) {
    ...
    //Split this into new function. convertPrivateKeyToPublicKey
    // privateKey = privateKey.substring(2)
    // privateKey = Buffer.from(privateKey, "hex")
    // let publicKey = eccrypto.getPublic(privateKey);

    let {x, y} = convertPublicKeyToXY(publicKey)
    // //Use convertPublicKeyToXY
    // let x = publicKey.slice(1, 33);
    // let y = publicKey.slice(33, 65);
    // let publicKeyX = '0x' + x.toString('hex')
    // let publicKeyY = '0x' + y.toString('hex')
...
// getKeyLength('0x88987af7d35eabcad95915b93bfd3d2bc3308f06b7197478b0dfca268f0497dc')
// getKeys('0x88987af7d35eabcad95915b93bfd3d2bc3308f06b7197478b0dfca268f0497dc')
...
//  getDIDDocument("did:signor:mainnet:0x88987af7d35eabcad95915b93bfd3d2bc3308f06b7197478b0dfca268f0497dc")

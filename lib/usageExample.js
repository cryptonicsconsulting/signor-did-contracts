...
await resolver.addKey(accounts[0], did, pub2.x, pub2.y, KeyPurpose.Authentication, ECCurve);
await resolver.addKey(accounts[0], did, pub3.x, pub3.y, KeyPurpose.Encryption, ECCurve);
